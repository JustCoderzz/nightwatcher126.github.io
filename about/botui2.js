...
function(e, t) {
	...
	function R(e) {
		...
		if (t) {
			...
			else if (o(t)) for (var s in t) r = t[s], i = Ti(s), a[i] = o(r) ? r : {
				type: r
			};
			e.props = a
		}
	...
	function Qn(e, t, n) {
		...
		if (!i || Array.isArray(r)) {
			for (var o, a, s = 0, c = e.options.length; s &lt; c; s++) if (a = e.options[s], i) o = _(r, er(a)) &gt; -1, a.selected !== o &amp;&amp; (a.selected = o);
	...
	function Er(e) {
		...
		for (t = 0, n = c.length; t &lt; n; t++) if (r = i = c[t].name, o = c[t].value, Bs.test(r)) if (e.hasBindings = !0, a = Nr(r), a &amp;&amp; (r = r.replace(Js, "")), zs.test(r)) r = r.replace(zs, ""), o = tn(o), s = !1, a &amp;&amp; (a.prop &amp;&amp; (s = !0, "innerHtml" === (r = Ti(r)) &amp;&amp; (r = "innerHTML")), a.camel &amp;&amp; (r = Ti(r)), a.sync &amp;&amp; un(e, "update:" + Ti(r), dn(o, "$event"))), s || bs(e.tag, e.attrsMap.type, r) ? an(e, r, o) : sn(e, r, o);
	...
	function Br(e, t) {
		if (1 === e.type) {
			...
			if (e.staticRoot = !1, e.children) for (var n = 0, r = e.children.length; n &lt; r; n++) Br(e.children[n], t || !! e.
			for);
...
function bot_ui_ini() {
	...
	var sure = function() {
		...
		thirdpart = function() {
			botui.message.add({
				delay: 1e3,
				content: "cungudafaæ˜¯æ‘å§‘å¤§å‘çš„æ‹¼éŸ³ï¼Œå¤§å‘åœ¨éŸ©è¯­å‘éŸ³ä¸­æ—¶å¾ˆåŽ‰å®³çš„æ„æ€ã€‚"
			}).then(function() {
				botui.action.button({
					delay: 1500,
					action: [{
		...
		fourthpart = function() {
			botui.message.add({
				delay: 1e3,
				content: "æˆ‘çš„æ¸¸æˆåå«æ‘å§‘,åŽæ¥ä¹Ÿæœ‰äººå«æˆ‘æ‘å§‘å­¦å§ "
			}).then(function() {
				botui.message.add({
					delay: 1100,
					content: "å¸Œæœ›è‡ªå·±æ‰“æ¸¸æˆå¾ˆåŽ‰å®³å§ï¼Œå“ˆå“ˆå“ˆ"
				}).then(function() {
					botui.action.button({
						delay: 1500,
						action: [{
							text: "åŸŸåæœ‰ä»€ä¹ˆå«ä¹‰å—ï¼Ÿ",
							value: "why-domain"
						}]
					}).then(function(a) {
						fifthpart()
		...
		fifthpart = function() {
			botui.message.add({
				...
				botui.message.add({
					delay: 1600,
					content: "é‚£ä¹ˆï¼Œç›¸é‡å°±æ˜¯ç¼˜åˆ†ï¼Œèµä¸ªèµžå§ ^_^"
				})
			})
		}
}--></div><script>
